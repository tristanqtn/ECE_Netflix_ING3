...
public class Documentaire extends PublicationVideo {
	...
	public Documentaire(Serie copie) {
	...
	public Documentaire(ArrayList<String> acteurs, ArrayList<String> genres, String realisateur, String titre,
			String description, double note, int duree, int timecode, boolean visionne) {
	...
	public String toString() {
		return ("Le documentaire nommé " + this.titre + " dure " + this.duree + " et a été réalisé par "
